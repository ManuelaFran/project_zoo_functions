...
describe('Testes da função getOpeningHours', () => {
  ...
  it('passado os argumentos Monday e 13:00-AM deve lançar uma exceção com a mensagem: "The hour must be between 0 and 12"', () => {
    expect(() => (getOpeningHours('Monday', '13:00-AM'))).toThrow('The hour must be between 0 and 12');
  });
  it('passado os argumentos Tuesday e 09:60-AM deve lançar uma exceção com a mensagem: "The minutes must be between 0 and 59"', () => {
